...
ultimo_precio<-as.vector(ultimo_precio)
  # Revaluación
...
VaRMontecarlo95<-mean(VaRSM95)
VaRMontecarlo975<-mean(VaRSM975)
VaRMontecarlo99<-mean(VaRSM99)

VaR_1<-cbind(VaRMontecarlo95,VaRMontecarlo975,VaRMontecarlo99)
...
# Ordenamos tabla por P&L
Tabla_Alisado <- Tabla_Alisado[with(Tabla_Alisado, order(-Tabla_Alisado$PL)), ] # Orden directo 
head(Tabla_Alisado)
...
VaR_AlisadoExp<-cbind(VaRAE_95,VaRAE_975,VaRAE_99) 
colnames(VaR_AlisadoExp) <-c("95%","97.5%","99%")
VaR_AlisadoExp
